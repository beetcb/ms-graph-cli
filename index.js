...
async function init(lang) {
  ...
  const i18nHints = {
    account_type: [
      ['Please select your OneDrive or SharePoint account type:', 'Global', 'Operated by 21Vianet in China'],
      ['请选择你的 OneDrive 或 SharePoint 账户类型:', '国际版', '世纪互联版'],
    ],
    deploy_type: [
      ['Please select your deploy type (OneDrive or SharePoint):', 'OneDrive', 'SharePoint'],
...
async function getDriveApi(credentials, lang) {
  ...
  const i18nHints = {
    ...
    sitePath: ['SharePoint sites path (e.g., /sites/centUser)', 'SharePoint sites path (比如：/sites/centUser)'],
  }
